...
class GrowingBatchNorm2d(nn.BatchNorm2d):
    """
    ...
    def __init__(
        ...
        """
        super(GrowingBatchNorm2d, self).__init__(
...
class GrowingBatchNorm1d(nn.BatchNorm1d):
    """
    ...
    def __init__(
        ...
        """
        super(GrowingBatchNorm1d, self).__init__(
            num_features=num_features,
            eps=eps,
            momentum=momentum,
            affine=affine,
    ...
    def grow(
        ...
        Same implementation as GrowingBatchNorm2d.grow()
        """
        if additional_features <= 0:
            raise ValueError(
                f"additional_features must be positive, got {additional_features}"
